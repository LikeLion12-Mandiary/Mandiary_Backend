...
class Diary(models.Model):
    ...
    image1 = models.ImageField(upload_to=diary_directory_path, blank=True, null=True)
    image2 = models.ImageField(upload_to=diary_directory_path, blank=True, null=True)
